      ...
      <div className="mx-auto max-w-[80rem] px-4 py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h4 className="text-body-large-strong">Documentation</h4>
            <ul className="text-secondary-foreground text-body-large space-y-2">
              <li>
                <Link
          ...
          {/* Resources */}
          <div className="space-y-4">
            <h4 className="text-body-large-strong">Resources</h4>
            <ul className="text-secondary-foreground text-body-large space-y-2">
              <li>
                <Link
          ...
          {/* Community */}
          <div className="space-y-4">
            <h4 className="text-body-large-strong">Community</h4>
            <ul className="text-secondary-foreground text-body-large space-y-2">
              <li>
                <Link
