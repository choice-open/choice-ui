      ...
      <div className="grid gap-6 sm:grid-cols-3">
        ...
        >
          ...
          <div>
            ...
            <p className="text-secondary-foreground">Star, fork, and contribute</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            ...
            <p className="text-secondary-foreground">Follow for updates</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            ...
            <p className="text-secondary-foreground">Chat with the community</p>
          </div>
        </Link>
      </div>
    </div>
