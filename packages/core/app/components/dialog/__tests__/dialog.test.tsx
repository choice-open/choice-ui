...
describe("Dialog", () => {
  ...
  describe("basic rendering", () => {
    ...
    it("applies custom className", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} className="custom-dialog">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("initialPosition", () => {
    ...
    positions.forEach(position => {
      it(`renders with ${position} position`, async () => {
        render(
          <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition={position}>
            <Dialog.Header title="Test Dialog" />
            <Dialog.Content>Dialog content</Dialog.Content>
          </Dialog>
        )
    ...
    it("respects positionPadding prop", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition="left-top" positionPadding={50}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("draggable", () => {
    it("enables dragging when draggable prop is true", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} draggable>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("does not enable dragging when draggable prop is false", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} draggable={false}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("resizable", () => {
    it("enables width resizing when resizable.width is true", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} resizable={{ width: true }}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("enables height resizing when resizable.height is true", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} resizable={{ height: true }}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("shows resize handles when resizable", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} resizable={{ width: true, height: true }}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("remember position and size", () => {
    it("remembers position when rememberPosition is true", () => {
      const { rerender } = render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} draggable rememberPosition>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      // Close dialog
      rerender(
        <Dialog open={false} onOpenChange={mockOnOpenChange} draggable rememberPosition>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("remembers size when rememberSize is true", () => {
      const { rerender } = render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} resizable={{ width: true, height: true }} rememberSize>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      // Close dialog
      rerender(
        <Dialog open={false} onOpenChange={mockOnOpenChange} resizable={{ width: true, height: true }} rememberSize>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("does not remember position when rememberPosition is false", () => {
      const { rerender } = render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} draggable rememberPosition={false}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      // Close dialog
      rerender(
        <Dialog open={false} onOpenChange={mockOnOpenChange} draggable rememberPosition={false}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("overlay and backdrop", () => {
    it("renders with overlay when overlay prop is true", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} overlay>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("does not render overlay when overlay prop is false", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} overlay={false}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("outside press", () => {
    it("closes dialog when clicking outside and outsidePress is true", async () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} outsidePress>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("does not close dialog when clicking outside and outsidePress is false", async () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} outsidePress={false}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("lifecycle callbacks", () => {
    it("calls afterOpenChange when opening", async () => {
      ...
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} afterOpenChange={mockAfterOpenChange}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("calls afterOpenChange when closing", async () => {
      ...
      // Close dialog
      rerender(
        <Dialog open={false} onOpenChange={mockOnOpenChange} afterOpenChange={mockAfterOpenChange}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("edge cases", () => {
    ...
    it("handles invalid initialPosition gracefully", () => {
      expect(() => {
        render(
          <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition={"invalid" as DialogPosition}>
            <Dialog.Header title="Test Dialog" />
            <Dialog.Content>Dialog content</Dialog.Content>
          </Dialog>
        )
    ...
    it("handles extreme viewport sizes", () => {
      ...
      expect(() => {
        render(
          <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition="left-top">
            <Dialog.Header title="Test Dialog" />
            <Dialog.Content>Dialog content</Dialog.Content>
          </Dialog>
        )
    ...
    it("handles window resize events", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition="right-bottom">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
  ...
  describe("bug regression tests", () => {
    it("BUG: initialPosition should not be overridden by remembered position", async () => {
      ...
      const { rerender } = render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} draggable rememberPosition initialPosition="left-top">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      rerender(
        <Dialog open={false} onOpenChange={mockOnOpenChange} draggable rememberPosition initialPosition="right-bottom">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      rerender(
        <Dialog open={true} onOpenChange={mockOnOpenChange} draggable rememberPosition initialPosition="right-bottom">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("BUG: multiple dialogs with same initialPosition should not interfere", () => {
      render(
        <div>
          <Dialog open={true} onOpenChange={jest.fn()} initialPosition="center-top">
            <Dialog.Header title="Dialog 1" />
            <Dialog.Content>Content 1</Dialog.Content>
          </Dialog>
    ...
    it("BUG: initialPosition with zero viewport size should not crash", () => {
      ...
      expect(() => {
        render(
          <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition="center">
            <Dialog.Header title="Test Dialog" />
            <Dialog.Content>Dialog content</Dialog.Content>
          </Dialog>
        )
    ...
    it("BUG: rapid open/close with initialPosition should not cause memory leak", async () => {
      const { rerender } = render(
        <Dialog open={false} onOpenChange={mockOnOpenChange} initialPosition="left-top">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      for (let i = 0; i < 20; i++) {
        ...
        rerender(
          <Dialog open={false} onOpenChange={mockOnOpenChange} initialPosition={position}>
            <Dialog.Header title="Test Dialog" />
            <Dialog.Content>Dialog content</Dialog.Content>
          </Dialog>
        )
    ...
    it("BUG: dialog with invalid initialPosition should fallback to center", () => {
      render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition={"invalid-position" as DialogPosition}>
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
    ...
    it("BUG: initialPosition should work with different viewport aspect ratios", () => {
      ...
      const { rerender } = render(
        <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition="right-top">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
      ...
      rerender(
        <Dialog open={true} onOpenChange={mockOnOpenChange} initialPosition="left-bottom">
          <Dialog.Header title="Test Dialog" />
          <Dialog.Content>Dialog content</Dialog.Content>
        </Dialog>
      )
