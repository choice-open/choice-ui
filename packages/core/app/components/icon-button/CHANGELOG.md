...
All notable changes to the Icon Button component will be documented in this file.
...
### Changed
- Update package version to 0.4.7, add 'dark' variant support to Button and IconButton components, and enhance styling
