...
All notable changes to the Chip component will be documented in this file.

## [2025-08-28]

### Changed
- Refactor UI components and stories for style consistency and clarity
...
### Changed
- Update package version to 0.1.7 and enhance Chip component with 'as' prop for flexible rendering
