...
All notable changes to the Segmented component will be documented in this file.
...
- fix: add onHoverChange handling to SegmentedItem component
...
- Update package version to 0.4.6, add variant support to Segmented components, and enhance styling

## [2025-05-13]

### Changed

- Update package version to 0.2.8 and enhance SegmentedItem component tooltip handling
