...
All notable changes to the Toggle Button component will be documented in this file.
...
- chore: bump version to 0.7.2 in package.json and update ToggleButtonProps interface

## [2025-05-22]

### Changed

- fix: Adds context menu support to toggle button component
