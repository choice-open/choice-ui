...
All notable changes to the Conditions component will be documented in this file.
...
- Refactor condition group styling and component structure
...
- Add conditions component with drag-and-drop and input types support
