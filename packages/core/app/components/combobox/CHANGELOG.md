...
All notable changes to the Combobox component will be documented in this file.
...
- Refactor Combobox and remove CoordinateMenu components
...
### Added
- Add `onClick` support to ComboboxTrigger and update dependencies
