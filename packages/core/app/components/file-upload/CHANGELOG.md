...
All notable changes to the File Upload component will be documented in this file.

## [2025-10-19]

### Changed

- Enhance file validation to support file extensions
...
- Update file upload, kbd, and docs
