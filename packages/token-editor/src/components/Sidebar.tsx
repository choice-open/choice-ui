  ...
  return (
    <aside className="flex flex-col gap-1 border-r border-border-default bg-background-default p-3">
      <div className="flex items-center justify-between px-2 py-2">
        <h1 className="text-sm font-semibold tracking-tight">Token Editor</h1>
      </div>
      ...
      <div className="mt-auto flex flex-col gap-1.5 px-2 pt-3">
        ...
        <div className="flex gap-1.5">
          <button
            ...
            className="flex-1 rounded border border-border-default px-2 py-1.5 text-xs hover:bg-background-component disabled:cursor-not-allowed disabled:opacity-50"
          >
            Reset
          </button>
          <button
            ...
            className="flex-[2] rounded border border-border-default bg-background-component px-2 py-1.5 text-xs font-medium hover:bg-background-component-hover"
          >
            Export…
          </button>
        </div>
